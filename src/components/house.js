  ...
  return (
    <div className="flex gap-8 items-center">
      <div className="grid w-1/2 space-y-4">
        ...
        <div>
          Built in {house.yr_built}, this {house.sqft_living} living sqft single
          family residence is located in Seattle, WA {house.zipcode}. It has{" "}
          {house.bedrooms} bedrooms and {house.bathrooms} bathrooms on a{" "}
      ...
      <div className="not-prose space-y-4 w-1/2 h-fit">
        ...
        <span className="grid grid-cols-2 gap-4">
          ...
          <img
            src="https://tailwindcss.com/_next/static/media/beach-house-interior-1.f151eb56.jpg"
            alt=""
            className="w-full h-30 h-full object-cover rounded-lg"
            loading="lazy"
          />
        </span>
      </div>
